...
class Category(MPTTModel):
    name = models.CharField(max_length=255, unique=True, verbose_name='Category Name', help_text='Required and unique')
    slug = models.SlugField(max_length=255, verbose_name=_('Category safe url'), unique=True)
...
class ImageLogo(models.Model):
    image =models.ImageField( verbose_name=_('image'), help_text=_('Upload a product image'), upload_to="images/", default="images/logo.png")
